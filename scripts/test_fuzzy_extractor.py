        ...
        json.dumps(
            {
                ...
                "first_pass_accepted": regeneration["first_pass_accepted"],
                "pose_retry_attempted": regeneration["pose_retry_attempted"],
                "pose_retry_refined": regeneration["pose_retry_refined"],
                "pose_retry_accepted": regeneration["pose_retry_accepted"],
